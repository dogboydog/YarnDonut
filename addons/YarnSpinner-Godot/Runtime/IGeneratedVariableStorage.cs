...
public static class GeneratedVariableStorageExtensions
{
        ...
        where T : System.Enum
    {
        ...
        {
            GD.PushError($"Failed to get a value of type {typeof(T).Name} for variable {variableName}.");
            return default;
        }
        ...
        {
            GD.PushError(
                $"Failed to get a value of type {typeof(T)} for variable {variableName}: ${caseValue} is not a valid case value.");
            return default;
        }
    }
}